  ...
  <footer class="footer pb-5">
    <div class="content has-text-centered">
      ...
      <div class="footpad footicons">
        Github - <a class="icon-tag" href="https://github.com/streambphc/gindex-v4">Shan.tk</a> | Support Me Test Just Kiddin!
      </div>
      ...
      <div v-if="license" class="footpad footer-policy">
        Licensed under FrontEnd - <a href="https://github.com/streambphc/gindex-v4/blob/dark-mode-0-1/LICENSE" target="_blank"> GPL 3.0 </a> | Backend - <a href="https://github.com/streambphc/gindex-v4/blob/dark-mode-0-1/vuejs/LICENSE" target="_blank">MIT</a>
      </div>
      <div v-if="codeofconduct" class="footpad footer-code">
        Please Read our <a href="https://github.com/streambphc/gindex-v4/blob/dark-mode-0-1/CODE_OF_CONDUCT.md" target="_blank">Code of Conduct</a> | <a href="https://raw.githubusercontent.com/streambphc/gindex-v4/dark-mode-0-1/CONTRIBUTING.md" target="_blank">Community Guidelines</a>
      </div>
    </div>
  </footer>
</template>
